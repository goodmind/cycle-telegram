...
exports.forwardMessage = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, from_chat_id = _a.from_chat_id, _b = _a.disable_notification, disable_notification = _b === void 0 ? null : _b, message_id = _a.message_id;
    var options = {
        chat_id: chat_id,
...
exports.sendPhoto = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, photo = _a.photo, _b = _a.caption, caption = _b === void 0 ? null : _b, _c = _a.disable_notification, disable_notification = _c === void 0 ? null : _c, _d = _a.reply_to_message_id, reply_to_message_id = _d === void 0 ? null : _d, _e = _a.reply_markup, reply_markup = _e === void 0 ? null : _e;
    var options = {
        chat_id: chat_id,
        photo: photo,
        caption: caption,
...
exports.sendDocument = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, document = _a.document, _b = _a.caption, caption = _b === void 0 ? null : _b, _c = _a.disable_notification, disable_notification = _c === void 0 ? null : _c, _d = _a.reply_to_message_id, reply_to_message_id = _d === void 0 ? null : _d, _e = _a.reply_markup, reply_markup = _e === void 0 ? null : _e;
    var options = {
        chat_id: chat_id,
        document: document,
        caption: caption,
...
exports.sendSticker = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, sticker = _a.sticker, _b = _a.disable_notification, disable_notification = _b === void 0 ? null : _b, _c = _a.reply_to_message_id, reply_to_message_id = _c === void 0 ? null : _c, _d = _a.reply_markup, reply_markup = _d === void 0 ? null : _d;
    var options = {
        chat_id: chat_id,
        sticker: sticker,
        disable_notification: disable_notification,
...
exports.sendVoice = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, voice = _a.voice, _b = _a.duration, duration = _b === void 0 ? null : _b, _c = _a.disable_notification, disable_notification = _c === void 0 ? null : _c, _d = _a.reply_to_message_id, reply_to_message_id = _d === void 0 ? null : _d, _e = _a.reply_markup, reply_markup = _e === void 0 ? null : _e;
    var options = {
        chat_id: chat_id,
        voice: voice,
        duration: duration,
...
exports.sendLocation = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, latitude = _a.latitude, longitude = _a.longitude, _b = _a.disable_notification, disable_notification = _b === void 0 ? null : _b, _c = _a.reply_to_message_id, reply_to_message_id = _c === void 0 ? null : _c, _d = _a.reply_markup, reply_markup = _d === void 0 ? null : _d;
    var options = {
        chat_id: chat_id,
        latitude: latitude,
        longitude: longitude,
...
exports.sendContact = ramda_1.curryN(2, function (_a, update) {
    var chat_id = _a.chat_id, phone_number = _a.phone_number, first_name = _a.first_name, _b = _a.last_name, last_name = _b === void 0 ? null : _b, _c = _a.disable_notification, disable_notification = _c === void 0 ? null : _c, _d = _a.reply_to_message_id, reply_to_message_id = _d === void 0 ? null : _d, _e = _a.reply_markup, reply_markup = _e === void 0 ? null : _e;
    var options = {
        chat_id: chat_id,
...
exports.editMessageCaption = ramda_1.curryN(2, function (_a, update) {
    var _b = _a.caption, caption = _b === void 0 ? null : _b, _c = _a.reply_markup, reply_markup = _c === void 0 ? null : _c;
    var options = {
        caption: caption,
        reply_markup: reply_markup
    };
...
exports.editMessageReplyMarkup = ramda_1.curryN(2, function (_a, update) {
    var _b = _a.reply_markup, reply_markup = _b === void 0 ? null : _b;
    var options = {
        reply_markup: reply_markup
    };
    return runtime_types_1.Request({
