...
exports.broadcast = ramda_1.curryN(2, function (options, update) {
    ...
    return runtime_types_1.Request({
        ...
        options: helpers_1.defaults({
            chat_id: ramda_1.defaultTo(ramda_1.path(['message', 'chat', 'id'], helpers_1.messageCase(update))),
...
exports.reply = ramda_1.curryN(2, function (options, update) {
    ...
    return runtime_types_1.Request({
        ...
        options: helpers_1.defaults({
            chat_id: ramda_1.defaultTo(ramda_1.path(['message', 'chat', 'id'], helpers_1.messageCase(update))),
            reply_to_message_id: ramda_1.defaultTo(ramda_1.path(['message', 'message_id'], helpers_1.messageCase(update))),
            text: ramda_1.defaultTo('Null-catch: no text provided'),
            reply_markup: JSON.stringify
...
exports.forwardMessage = ramda_1.curryN(2, function (options, update) {
    ...
    return runtime_types_1.Request({
        ...
        options: helpers_1.defaults({
            from_chat_id: ramda_1.defaultTo(ramda_1.path(['message', 'chat', 'id'], helpers_1.messageCase(update))),
            message_id: ramda_1.defaultTo(ramda_1.path(['message', 'message_id'], helpers_1.messageCase(update)))
...
exports.sendGame = ramda_1.curryN(2, function (options, update) {
    if (options === void 0) { options = {}; }
    return runtime_types_1.Request({
        type: 'sink',
        method: 'sendGame',
...
exports.setGameScore = ramda_1.curryN(2, function (options, update) {
    if (options === void 0) { options = {}; }
    return runtime_types_1.Request({
        type: 'sink',
        method: 'setGameScore',
...
exports.getGameHighScores = ramda_1.curryN(2, function (options, update) {
    if (options === void 0) { options = {}; }
    return runtime_types_1.Request({
        type: 'sink',
