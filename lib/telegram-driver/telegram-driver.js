...
function makeEventsSelector(_a) {
    var message = _a.message, channelPost = _a.channelPost, editedMessage = _a.editedMessage, editedChannelPost = _a.editedChannelPost, inlineQuery = _a.inlineQuery, chosenInlineResult = _a.chosenInlineResult, callbackQuery = _a.callbackQuery;
