...
var getEntityFirst = exports.getEntityFirst = (0, _ramda.curryN)(2, function (type, update) {
  return (0, _ramda.find)((0, _ramda.propEq)('type', type), (0, _ramda.defaultTo)([])((0, _ramda.path)(['message', 'entities'], update)));
});
