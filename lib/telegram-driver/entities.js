...
var getEntityFirst = exports.getEntityFirst = (0, _ramda.curryN)(2, function (type, _ref) {
  var _ref$message$entities = _ref.message.entities;
  var entities = _ref$message$entities === undefined ? [] : _ref$message$entities;
  return (0, _ramda.find)((0, _ramda.propEq)('type', type))(entities);
});
