...
function createResponse(_a, multipart) {
...
function makeRequestToResponse(request) {
    return function requestToResponse(response) {
...
function makeAPIRequest(apiReq, multipart) {
