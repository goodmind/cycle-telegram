...
var commandName = exports.commandName = function commandName(update) {
  return (0, _index.getEntityFirst)('bot_command')(update);
};

var findCommandIn = exports.findCommandIn = (0, _ramda.curry)(function (commands, path) {
  ...
  if (!match) {
    match = (0, _ramda.takeLast)(1, commands)[0];
  }
