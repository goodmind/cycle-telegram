...
function makePlugins(externalSA) {
    if (externalSA === void 0) { externalSA = rxjs_adapter_1.default; }
    function matchWith(plugins, sources, _a) {
        var _b = (_a === void 0 ? { dupe: true } : _a).dupe, dupe = _b === void 0 ? true : _b;
        return helpers_1.convertStream(helpers_1.convertStream(this, externalSA, rxjs_adapter_1.default)
            .map(function (u) { return dupe ? toComponents(u) : toComponent(u); })
            .flatMap(function (f) { return f(plugins, sources); })
            .filter(ramda_1.prop('bot')), rxjs_adapter_1.default, externalSA);
    }
    function matchStream(sourceObservable) {
        ...
        return matchWith.apply(helpers_1.convertStream(sourceObservable, externalSA, rxjs_adapter_1.default), args);
    }
